    ...
    def post(self, request):
        ...
        if register_form.is_valid():
            ...
            if user:
                ...
                new_user.save()
                send_email('یک نامه از طرف عمو ممد', new_user.email, {'user': new_user}, 'emails/activate_account.html')
                messages.success(request, 'لطفاً ایمیل خود را بررسی کنید.')
...
#     return render(request, 'account_module/login.html', {'success_message': success_message})
